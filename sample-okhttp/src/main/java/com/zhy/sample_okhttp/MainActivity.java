...
//        url =3.125.219.144:8443/mobileConnect/MobileConnect/authLogin.action?systemid=100009&mobile=13260284063&pipe=2&reqtime=1422986580048&ispin=2";
    ...
    public void uploadFile(View view)
    {
        ...
        File file = new File(Environment.getExternalStorageDirectory(), "logo.gif");
        if (!file.exists())
        {
            Toast.makeText(MainActivity.this, "文件不存在，请修改文件路径", Toast.LENGTH_SHORT).show();
            return;
        ...
        String url = "http://192.168.31.64:8080/FileUpload/FileUploadServlet";

        OkHttpUtils.post()//
                .addFile("mFile", "logo.gif", file)//
                .url(url)//
                .params(params)//
                .headers(headers)//
                .build()//
